...
Route19_MapEventHeader: ; 0x19ee31
	...
	person_event SPRITE_SWIMMER_GUY, 32, 17, $1e, $0, 255, 255, $82, 3, TrainerSwimmermHarold, $ffff
	person_event SPRITE_SWIMMER_GUY, 21, 15, $1e, $0, 255, 255, $82, 3, TrainerSwimmermJerome, $ffff
