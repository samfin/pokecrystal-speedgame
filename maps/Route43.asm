...
Route43_MapEventHeader: ; 0x19d78c
	...
	person_event SPRITE_SUPER_NERD, 24, 17, $1e, $0, 255, 255, $92, 3, TrainerPokemaniacBrent1, $ffff
	...
	person_event SPRITE_YOUNGSTER, 44, 17, $1e, $0, 255, 255, $a2, 3, TrainerCamperSpencer, $ffff
