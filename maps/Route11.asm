...
Route11_MapEventHeader: ; 0x68242
	...
	; people-events
	db 5
	person_event SPRITE_YOUNGSTER, 18, 26, $1e, $0, 255, 255, $92, 3, TrainerYoungsterOwen, $ffff
	...
	person_event SPRITE_YOUNGSTER, 10, 12, $1e, $0, 255, 255, $92, 3, TrainerPsychicFidel, $ffff
